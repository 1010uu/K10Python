...
# for문이 딱 한번만 실행된 후 break를 만나 탈출하게 되므로 else는 실행되지 않는다.
for i in range(3):
    print(i, end=" ")
    break
else:
...
'''
입력월이 3이상이고, 입력년도가 윤년이라면 1을 더해야한다.
...
#총 누적된 날에 현재 년도의 일수를 더해준다.
total_days+=day
print()
print("total_days:", total_days)
remainder = total_days%7

#요일은 일요일부터 시작이므로 나머지가 0이라면 일요일로 판단
if remainder==0:
    print("일요일입니다.")
if remainder==1:
    print("월요일입니다.")
