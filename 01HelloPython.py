...
print("Hello Python")
# 한줄에 여러 명령을 쓰는 경우 ;으로 구분한다.
print("한줄에"); print("여러줄 쓰려면"); print("세미콜론이 필요해")

print("=======================")
print("여러 변수 선언")
print("=======================")
# 좌측항은 변수, 우측항은 할당할 값으로 구분하여 선언 및 초기화
...
print(engStr[:3]) #0~3까지의 범위에서 3앞까지 온다. : Hel
print(engStr[1:3]) #1~2까지
print(engStr[1:]) #1~마지막까지
...
#인덱스 대신 변수를 사용하는 방법. 단 default값을 지정할 때는 "변수명=값"으로 사용한다.
menu1 ="치킨"
menu2 ="맥주"
